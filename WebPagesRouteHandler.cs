 class WebPagesRouteHandler : IRouteHandler
    {
    ...
    public static class RouteCollectionExtension
    {
        ...
        /// <param name="virtualPath">The virtual path of the web page *.cshtml</param>
        /// <param name="defaultValues">Paremeters default. Ejem: new { Code = "MX-123" } to path: /realties/{Code}</param>
